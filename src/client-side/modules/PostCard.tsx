...
import { postCardHeaderStyle, postCardMessageStyle, postCardStyle, postCardTitleStyle } from '../style/postStyle.ts';
    ...
    return (
        <Card raised elevation={3} id={`post-${post.id}`} sx={postCardStyle()}>
            ...
            <CardContent>
                ...
                <Typography sx={postCardMessageStyle()}>{message}</Typography>
